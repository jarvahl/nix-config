    ...
    hjem = { pkgs, ... }:
      {
        nvf.vim = lib.mkMerge [
          ...
          {
            # buffer cleanup
            lazy.plugins.nvim-early-retirement = {
              package = inputs.nixpkgs.legacyPackages.${pkgs.system}.vimPlugins.nvim-early-retirement;
              setupModule = "early-retirement";
              setupOpts = {
          ...
          }
          {
            ...
            lazy.plugins."filemention.nvim" = {
              package = pkgs.vimPlugins.filemention-nvim;
          ...
          }
          {
            ...
            lazy.plugins."guess-indent.nvim" = {
              package = inputs.nixpkgs.legacyPackages.${pkgs.system}.vimPlugins.guess-indent-nvim;
              setupModule = "guess-indent";
            };
          }
          {
            # fyler
            lazy.plugins."fyler.nvim" = {
              package = inputs.nixpkgs.legacyPackages.${pkgs.system}.vimPlugins.fyler-nvim;
              setupModule = "fyler";
              setupOpts = {
                follow_current_file = true;
                kind = "floating";
                kind_presets.floating = {
                  width = "100%";
                  height = "100%";
                  row = "start";
                  col = "start";
